...
Standard robotic datasets (like the [YCB]{https://registry.opendata.aws/ycb-benchmarks/} and [Columbia libraries]{https://www.kaggle.com/datasets/jessicali9530/coil100}) do not reflect real-world clinical workflows. Nursing environments feature challenging items—such as thin packaging, deformable materials, transparent surfaces, and irregular geometries—that require specialized object sets for accurate benchmarking and manipulation.
